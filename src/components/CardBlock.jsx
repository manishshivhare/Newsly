const Card = (props) => {
  return (
    <div className="relative max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg transition-transform transform hover:scale-105 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="absolute bottom-2 right-2 text-sm text-gray-500 dark:text-gray-400">
        <span>Source-</span>
        <a href={props.sourceLink} className="ml-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
          {props.sourceName}
        </a>
      </div>
    </div>
